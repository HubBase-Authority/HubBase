...
def create_key():
    return Item("Key", "Opens locked doors", {"special_use_conditions": ["unlock"]})


def create_punch():
    return Item("Punch", "Left on table for 2 weeks", {"HealAmount": random.randint(-150, 25), "Target": "Player"})


def create_stalker():
    return Creature("Shadow Stalker")
